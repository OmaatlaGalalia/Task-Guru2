    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md text-center">
          ...
          <h2 className="mt-3 text-2xl font-bold text-gray-900">Message Sent!</h2>
            ...
            <form ref={form} onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className={`mt-1 block w-full border ${errors.message ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
                />
            ...
            <div className="bg-white p-6 rounded-xl shadow-md space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-gray-600">
                    Mosekangwetsi street<br />
                    Gaborone Phase 1, 16476
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-gray-600">+267 75055659</p>
                  <p className="mt-1 text-sm text-gray-500">Mon-Fri, 9am-5pm CAT</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-gray-600">omaatlagalalia@gmail.com</p>
              ...
              <div className="pt-4">
                ...
                <div className="flex space-x-4">
                  <a href="https://www.facebook.com/profile.php?id=100073378734100&sk=about" className="text-gray-500 hover:text-blue-600">
                  ...
                  <a href="https://bw.linkedin.com/in/omaatla-galalia-745a4228b" className="text-gray-500 hover:text-blue-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl overflow-hidden shadow-md">
            <iframe
              ...
              marginHeight="0"
              marginWidth="0"
              src="https://maps.google.com/maps?q=Gaborone,Botswana&t=&z=13&ie=UTF8&iwloc=&output=embed"
              className="border-0"
            ></iframe>
          </div>
        </div>
